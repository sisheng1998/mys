...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 [--cell-size-small:--spacing(8)] [--cell-size:--spacing(10)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size-small) p-0 select-none aria-disabled:pointer-events-none aria-disabled:opacity-50",
        ...
        month_caption: cn(
          "flex h-(--cell-size-small) w-full items-center justify-center px-(--cell-size-small)",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full max-w-(--cell-size) p-0 text-center select-none [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
        ...
        DayButton: ({ className, children, ...props }) => {
          ...
          return (
            <CalendarDayButton
              ...
              {...props}
            >
              <span className="leading-none opacity-100!">{children}</span>
