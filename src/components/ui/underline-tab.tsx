...
function UnderlineTabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "ring-offset-background hover:text-accent-foreground data-[state=active]:text-primary data-[state=active]:border-b-primary hover:bg-muted/50 data-[state=active]:hover:bg-primary/10 relative z-0 inline-flex items-center justify-center rounded-t-sm border-b-2 border-b-transparent bg-transparent px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      {...props}
    />
